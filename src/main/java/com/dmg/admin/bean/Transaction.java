...
public class Transaction extends AbstractPojo {
	...
	public String toString() {
		return "Transaction [contractNo=" + contractNo + ", city=" + city + ", orderInfo=" + orderInfo + ", status=" + status + ", amount=" + amount + ", command=" + command + ", merchTxnRef="
				+ merchTxnRef + ", secureHash=" + secureHash + ", secureHashType=" + secureHashType + ", syncStatus=" + syncStatus + ", version=" + version + ", locale=" + locale + ", returnURL="
				+ returnURL + ", accessCode=" + accessCode + ", merchant=" + merchant + ", fees=" + fees + ", id=" + id + ", creationDate=" + creationDate + ", updateDate=" + updateDate + "]";
	}
